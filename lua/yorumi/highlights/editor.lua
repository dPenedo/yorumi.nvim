...
function M.setup(config)
	...
	return {
		...
		LineNr = { fg = palette.tsuki0 },
		CursorLineNr = { bg = palette.yoru2, fg = palette.tsuki4 },
		MatchParen = { bg = palette.yoru3, fg = palette.kairoYellow, bold = true },
		...
		PmenuSel = { bg = palette.kuroiBlue, fg = palette.tsuki3 },
		...
		DiagnosticUnderlineWarn = {
			undercurl = config.undercurl,
			underline = not config.undercurl,
			sp = palette.sangoYellow,
		},
		DiagnosticUnderlineInfo = {
			undercurl = config.undercurl,
			underline = not config.undercurl,
			sp = palette.kairoBlue,
		},
		DiagnosticUnderlineHint = {
			undercurl = config.undercurl,
			underline = not config.undercurl,
			sp = palette.sangoCyan,
		},
